...
include "loop_through_articles.php"
?>
<!doctype html>
<html lang="en">
...
<head>
  ...
  <meta name="author" content="Jesus Hilario Hernandez">
...
<body>
  ...
  <div class="container">
    ...
    <div class="article-div">
      <?php if (!(isset($result->{"response"}->{"docs"}[0]))) {
              echo "<h4>Sorry. No results for <span>" . $search_term . "</span></h4>";
            } else {
              echo "<h4>Showing results for <span>" . $search_term . "</span></h4>";
              echo loop_through_articles($result, 0, 2);
              echo loop_through_articles($result, 2, 5);
              echo loop_through_articles($result, 5, 6);
              echo loop_through_articles($result, 6, 9);
              echo loop_through_articles($result, 9, 10);
            }
      ?>
    </div>
    ...
    <div class="footer">
      ...
      <div class="footer-box-2">
        <p class="footer-para-1">Produced by
          <a href="https://twitter.com/jesushilarioh" target="_blank">Jesús Hilario H</a>.
        </p>
      </div>
    </div>
